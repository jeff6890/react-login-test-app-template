...
export class PasswordResetForm extends React.Component {
    ...
    handleSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        if (this.state.password !== this.state.passwordVerify) {
            return this.setAlertMessage('Passwords need to match.');
        }
        ...
        Userfront.resetPassword({
            ...
            if (error.message === "Password must be at least 16 characters OR at least 8 characters including a number and a letter") {
